...
export default function TablePagination({ data, action, isquestion }) {
    ...
    const handleDeleteQuestion = id => {
        axios.delete(`http://apnardeenijiggasa.com/backend/api/v1/delete/question/${id}`)
            .then(res => {
                if (res.status === 200) {
    ...
    const handleDeletePost = id => {
        axios.delete(`http://apnardeenijiggasa.com/backend/api/v1/delete/post/${id}`)
            .then(res => {
                if (res.status === 200) {
                    alert('Successfully Deleted !')
                    window.location.reload()
    ...
    const handleDeleteVideo = id => {
        axios.delete(`http://apnardeenijiggasa.com/backend/api/v1/delete/video/${id}`)
            .then(res => {
                if (res.status === 200) {
    ...
    const handleDeletePdf = id => {
        axios.delete(`http://apnardeenijiggasa.com/backend/api/v1/delete/pdf/${id}`)
            .then(res => {
                if (res.status === 200) {
